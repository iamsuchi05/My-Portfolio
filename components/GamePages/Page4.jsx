...
const projects = [
	{
		...
		title: "Swiggy Clone",
		desc: "Built a responsive food delivery web application inspired by Swiggy. Implemented restaurant listings, menu pages, and dynamic UI components. Used React and Tailwind CSS for frontend development.",
		links: [
			{
				label: "GitHub",
				url: "https://github.com/iamsuchi05/swiggy-project",
			},
		],
	},
	{
		...
		title: "YouTube Clone",
		desc: "Developed a video streaming platform UI similar to YouTube. Implemented video cards, search interface, category filtering, and responsive layouts. Built using React and JavaScript.",
		links: [
			{ label: "GitHub", url: "https://github.com/iamsuchi05/youtube-project" },
		],
	},
	{
		id: 3,
		...
		title: "Netflix Clone",
		desc: "Created a Netflix-inspired movie browsing application. Designed modern UI layouts with responsive sections and movie banners. Used React and CSS/Tailwind for styling.",
		links: [
			{
				label: "GitHub",
				url: "https://github.com/iamsuchi05/netflix-gemini.git",
			},
		],
	},
];
