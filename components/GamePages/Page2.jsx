...
const Page2 = ({ goNext }) => {
  ...
  <body>
    <h1>My name is Suchi</h1>
    <h2>Facts about me:</h2>
    <ul>
      <li>I am a B.Com graduate
      <li>I do frontend development</li>
      <li>I built Swiggy, YouTube, and Netflix clones</li>
    </ul>
  </body>
</html>`;
					...
					{viewMode === "code" ? (
						...
						<div className="w-[40vw] h-[35vh] px-[2vw] py-[2vh] border-[1px] border-neutral-400 rounded-xl bg-white">
							...
							<ul className="list-disc ml-6">
								...
								<li className="handlee text-[2.25vh] font-medium">
									I built Swiggy, YouTube, and Netflix clones
								</li>
							</ul>
						</div>
					)}
